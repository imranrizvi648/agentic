...
//         },
//         {
//           rootMargin: "-10% 0px -10% 0px", // Margin thora adjust kiya hai smooth reveal ke liye
//           threshold: 0,
//         }
//       );
...
//       style={{
//         background: "#fff",
//         padding: "48px 0 160px", // Bottom padding barhai hai taqay scroll karne ki jagah milay
//       }}
//     >
//       {/* SERVICES label */}
//       <div
...
//       {/* Rows */}
//       <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "0 56px", position: "relative" }}>
//         {services.map((s, i) => (
//           <ServiceRow
//             key={i}
//             index={i} // Index pass kiya offset calculate karne ke liye
...
//       style={{
//         position: "sticky",
//         // Ye logic "ek ke upar ek" stack karne ka magic hai:
//         top: `${100 + index * 40}px`, 
//         backgroundColor: "#fff", // Background zaroori hai taqay pechli layer chup jaye
//         zIndex: index + 1, // Nayi layer hamesha upar aayegi
//         borderTop: "1px solid rgba(0,0,0,0.1)",
//         borderBottom: isLast ? "1px solid rgba(0,0,0,0.1)" : "none",
//         paddingBottom: "24px",
//         boxShadow: "0 -8px 20px rgba(0,0,0,0.03)", // Halki si shadow depth feel dene ke liye
//       }}
//     >
//       {/* ── Always visible: number + title + image ── */}
//       <div
//         style={{
//           display: "grid",
...
//         {/* Title — FONT SIZE CHOTA KIYA HAI */}
//         <h3
//           style={{
//             fontSize: "clamp(24px, 3.5vw, 48px)", // 66px se kam kar ke 48px kar diya hai
//             fontWeight: 900,
...
//           overflow: "hidden",
//           transition:
//             "max-height 0.65s cubic-bezier(0.22,1,0.36,1), opacity 0.45s ease",
//           paddingBottom: expanded ? "32px" : "0",
//         }}
//       >
//         <div />
//         <div>
//           <p
//             style={{
//               fontSize: "15px", // Desc ka size bhi thora sa adjust kiya hai
//               lineHeight: 1.72,
//               color: "#555",
//               fontFamily: "'DM Sans', sans-serif",
//               margin: "18px 0 22px",
...
//             }}
//             onMouseEnter={(e) => {
//               e.currentTarget.style.background = "#ea6c04";
